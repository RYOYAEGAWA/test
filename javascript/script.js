...
function oshiharai(num){
    return"会員Noは"+num+"です。";
}

document.write(oshiharai(1022));
document.write("<br>");

document.write(oshiharai(1199));
document.write("<br>");

document.write(oshiharai(2047));
document.write("<br>");